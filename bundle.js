...
exports.setForks = exports.setLicense = exports.setStars = exports.setLanguage = exports.setName = exports.showOrHideElementBasedOnData = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _templatePolyfill = require('template-polyfill');
...
var showOrHideElementBasedOnData = exports.showOrHideElementBasedOnData = function showOrHideElementBasedOnData(element, isVisible) {
    if (!isVisible) {
...
var setName = exports.setName = function setName(template, repo) {
    var nameEl = template.content.querySelector('.repo-name');
...
var setLanguage = exports.setLanguage = function setLanguage(template, repo) {
    var languageElement = template.content.querySelector('.repo-element--language');
...
var setStars = exports.setStars = function setStars(template, repo) {
    var starsElement = template.content.querySelector('.repo-element--stars');
...
var setLicense = exports.setLicense = function setLicense(template, repo) {
    var licenseElement = template.content.querySelector('.repo-element--license');
...
var setForks = exports.setForks = function setForks(template, repo) {
    var forksElement = template.content.querySelector('.repo-element--forks');
...
var RepoListView = function () {
    function RepoListView(options) {
        _classCallCheck(this, RepoListView);
    ...
    _createClass(RepoListView, [{
        ...
        key: 'removeAllRepoElement',
        value: function removeAllRepoElement() {
        ...
        key: 'renderElement',
        value: function renderElement(repo) {
        ...
        value: function render() {
            ...
            list.map(function (repo) {
                return _this.renderElement(repo);
            }).forEach(function (element) {
                _this.elements.list.appendChild(element);
            });
        }
    }]);
...
exports.default = RepoListView;

},{"template-polyfill":3}],6:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.hideSearchResultsCounter = exports.searchAndRenderResultsCounter = exports.getMessageForFoundReposCount = exports.toHashMap = undefined;
...
var toHashMap = exports.toHashMap = function toHashMap(list) {
    return list.reduce(function (previousValue, currentValue, currentIndex) {
        previousValue[currentValue.name] = currentValue;
        return previousValue;
    }, {});
};

var getMessageForFoundReposCount = exports.getMessageForFoundReposCount = function getMessageForFoundReposCount(count) {
    if (count <= 0) {
        return '<strong>No repositories found</strong>';
    }
    var repoText = count === 1 ? 'repository' : 'repositories';
    return 'Found <strong>' + count + '</strong> ' + repoText;
};

var searchAndRenderResultsCounter = exports.searchAndRenderResultsCounter = function searchAndRenderResultsCounter(count) {
    var counterElement = document.querySelector('.search-counter');
    counterElement.innerHTML = getMessageForFoundReposCount(count);
    counterElement.classList.remove('search-counter--hidden');
};

var hideSearchResultsCounter = exports.hideSearchResultsCounter = function hideSearchResultsCounter() {
    var counterElement = document.querySelector('.search-counter');
...
var SearchView = function () {
    function SearchView(options) {
        ...
        this.list = [];
        this.options = Object.assign({
            listRenderer: function listRenderer() {},
            selector: null
        }, options);
    }
    ...
    _createClass(SearchView, [{
        key: 'setList',
        value: function setList(list) {
            this.fuse = new _fuse2.default(list, _options.searchOptions);
            this.list = list;
        }
    }, {
        key: 'onSubmit',
        ...
        value: function onInput(event) {
            if (event.keyCode === _constants.KEY_ESCAPE) {
                this.elements.input.value = QUERY_EMPTY;
                this.searchAndRenderResults(QUERY_EMPTY);
                return;
            }
            var query = this.elements.input.value;
            this.searchAndRenderResults(query);
        }
    }, {
        key: 'mount',
        value: function mount() {
            var form = document.querySelector(this.options.selector);
        ...
        value: function search(query) {
            ...
            var repoHashMap = toHashMap(this.list);
            return results.map(function (name) {
                return repoHashMap[name];
            });
        }
    }, {
        key: 'searchAndRenderResults',
        value: function searchAndRenderResults(query) {
            if (query.trim() === QUERY_EMPTY) {
                this.options.listRenderer(this.list);
                hideSearchResultsCounter();
                return;
            }
            var searchResults = this.search(query);
...
var CLIENT_ID = exports.CLIENT_ID = '8b3487982bc3693b68f8';
var CLIENT_SECRET = exports.CLIENT_SECRET = '039dca12108cb4985c3fa01d9950f203c0bb745e';

var REPOS_PER_PAGE = exports.REPOS_PER_PAGE = 1000;

var URL_REPOS = exports.URL_REPOS = 'https://api.github.com/orgs/rstgroup/repos?per_page=' + REPOS_PER_PAGE + '&client_id=' + CLIENT_ID + '&client_secret=' + CLIENT_SECRET;
...
var showError = exports.showError = function showError(errorMessage) {
    ...
    var errorMessageTextElement = document.querySelector('.errorMessage-text');
...
var _RepoListView = require('./RepoListView');

var _RepoListView2 = _interopRequireDefault(_RepoListView);
...
window.addEventListener('load', function () {
    var repoListView = new _RepoListView2.default({
        selector: '#repoList',
    ...
    (0, _api.fetchRepos)().then(function (repoList) {
        ...
        console.error(error);
        (0, _error.showError)('Could not fetch repositories');
    });
});
...
var searchOptions = exports.searchOptions = {
    keys: [{ name: 'name', weight: .9 }, 'license.name', 'license.key', 'license.spdx_id', 'language'],
    id: 'name'
};
